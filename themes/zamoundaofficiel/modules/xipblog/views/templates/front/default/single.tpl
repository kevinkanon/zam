						...
						<div class="blog_post_content_top">
							<div class="post_thumbnail">
								...
								{elseif $xipblogpost.post_format == 'gallery'}
									...
									{include file="module:xipblog/views/templates/front/default/post-gallery-freebie.tpl" gallery_lists=$xipblogpost.gallery_lists imagesize="large" class=$class}
								{else}
									<img class="xipblog_img img-thumbnail" src="{$xipblogpost.post_img_large}" alt="{$xipblogpost.post_title}">
								{/if}
							</div>
						</div>
