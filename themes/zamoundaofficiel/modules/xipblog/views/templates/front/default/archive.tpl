	...
	<div class="kr_blog_post_area">
		<div class="kr_blog_post_inner blog_style_{$xipblogsettings.blog_style} column_{$xipblogsettings.blog_no_of_col}">
			{foreach from=$xipblogpost item=xpblgpst}
				<article id="blog_post" class="blog_post blog_post_{$xpblgpst.post_format} clearfix col-xs-12 col-sm-12 col-md-3 h-15">
					<div class="blog_post_content">
						<div class="blog_post_content_top">
							...
							{block name="xipblog_post_thumbnail"}
								...
								{else}
									<img class="img-thumbnail" src="{$xpblgpst.post_img_large}" alt="{$xpblgpst.post_title}">
									<div class="blog_mask">
						...
						<div class="blog_post_content_bottom">
							...
							<div class="content_more">
								<a class="read_more" href="{$xpblgpst.link}">{l s='Continue' mod='xipblog'}<i class="fas fa-arrow-circle-right" style="margin-left: 0.5rem;"></i></a>
							</div>
						</div>
