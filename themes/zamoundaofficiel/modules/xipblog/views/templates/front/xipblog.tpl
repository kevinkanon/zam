<div class="home_blog_post_area {$xipbdp_designlayout} {$hookName}">
	<div class="home_blog_post">
		<div class="page_title_area">
			{if isset($xipbdp_title)}<h3 class="page-heading">{$xipbdp_title}<span class="heading_carousel_arrow"></span></h3>{/if}
			{if isset($xipbdp_subtext)}<p class="page_subtitle">{$xipbdp_subtext}</p>{/if}
					...
					<div class="blog_post_content">
							...
							<div class="post_thumbnail">
								...
								{elseif $xipblgpst.post_format == 'gallery'}
									{if $xipblgpst.gallery_lists|@count > 1 }
										...
										{include file="module:xipblog/views/templates/front/post-gallery.tpl" gallery=$xipblgpst.gallery_lists imagesize="large" class="carousel"}
									{else}
										...
										{include file="module:xipblog/views/templates/front/post-gallery.tpl" gallery=$xipblgpst.gallery_lists imagesize="large" class=""}
									{/if}
								{else}
									<img class="xipblog_img img-thumbnail" src="{$xipblgpst.post_img_home_default}" alt="{$xipblgpst.post_title}">
									<div class="blog_mask">
						...
						<div class="blog_post_content_bottom">
							...
							<div class="content_more">
								<a class="read_more" href="{$xipblgpst.link}">{l s='Continue' mod='xipblog'}<i class="fas fa-arrow-circle-right" style="margin-left: 0.5rem;"></i></a>
							</div>
						</div>
					</div>
				</article>
