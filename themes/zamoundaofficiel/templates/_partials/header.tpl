    ...
    <div class="container">
      ...
      {*
        <div class="hidden-sm-down">
          <div class="col-md-5 col-xs-12">{hook h='displayNav1'}</div>
          <div class="col-md-7 right-nav">{hook h='displayNav2'}</div>
        </div>
      *}
      ...
      *}
        <div class="col-sm-12 position-static">
          <div class="col-sm-3" id="_desktop_logo">
            <a href="{$urls.base_url}"><img class="" src="{$urls.img_ps_url}zamoundaofficiel-logo.png" alt="{$shop.name}"></a>
          </div>
